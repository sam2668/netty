...
public class DnsNameResolver extends SimpleNameResolver<InetSocketAddress> {
     ...
     */
    public DnsNameResolver setQueryTimeoutMillis(int queryTimeoutMillis) {
    ...
    /**
     * Returns the preferred protocol family of the resolved address.
     * The default value is {@link InternetProtocolFamily#IPv4}.
     *
     * @see #setPreferredProtocolFamily(InternetProtocolFamily)
     */
    ...
    /**
     * Sets the preferred protocol family of the resolved address. If a host name has both IPv4 and IPv6 addresses,
     * this resolver will choose the one of the preferred protocol family.
     *
     * @return {@code this}
     *
     * @see #preferredProtocolFamily()
     */
    public DnsNameResolver setPreferredProtocolFamily(InternetProtocolFamily preferredProtocolFamily) {
    ...
    private final class DnsResponseHandler extends ChannelInboundHandlerAdapter {
        ...
        private void cache(DnsQuestion question, DnsResponse res) {
            ...
            res.retain();
            queryCache.put(question, new DnsCacheEntry(res));
